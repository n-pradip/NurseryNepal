    ...
    return (
        <nav>
            <div className="upper-nav-section">
                <div className="px-[10px] lg:container flex flex-col justify-center mx-auto p-2 lg:flex-row lg:justify-between">
                    <div className="logo_container py-2 flex justify-center lg:block">
                        <img src={Logo} alt="logo" className="h-[55px]" />
                    </div>

                    <div className="searchbar flex align-center justify-center my-auto py-2 drop-shadow-md font-cabin lg:w-full">
        ...
        <div class="container mx-auto">
            <div class="flex flex-col lg:flex-row w-full justify-between">
                <Link to="#" class="nav-style" style={{borderLeft:"1px solid rgba(255,255,255,0.45)" }}>Gardening</Link>
