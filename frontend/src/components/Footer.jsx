                            ...
                            <div class="col-span-2">
                                <div>
                                    ...
                                    <p class="mt-4 text-gray-500">
                                        An online nursery business with complete solution for home decor, corporate decor and accesories.
                                    </p>
                                </div>
                            </div>
                                ...
                                <form class="w-full">
                                    ...
                                    <div
                                        ...
                                        <input
                                            type="email"
                                            id="UserEmail"
                                            placeholder="yourmailaddress@example.com"
                    ...
                    <div class="pt-8 mt-8 border-t border-gray-100">
                        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                            <p class="text-xs text-left text-gray-500">
                                &copy; 2022. Nursrey Nepal. All rights reserved.
                            </p>
